package com.glinboy.sample.longid.aop;
...
public class MethodExecutionMetricsAspect {
    ...
    @Pointcut("execution(* com.glinboy.sample.longid.web.rest..*(..))")
    private void controllerLayer() {
    }

    @Pointcut("execution(* com.glinboy.sample.longid.service..*(..))")
    private void serviceLayer() {
    }

    @Pointcut("execution(* com.glinboy.sample.longid.repository..*(..))")
    ...
    private String determineLayer(ProceedingJoinPoint joinPoint) {
        return switch (joinPoint.getSignature().getDeclaringTypeName()) {
            case String s when s.startsWith("com.glinboy.sample.longid.web.rest.") -> "Controller";
            case String s when s.startsWith("com.glinboy.sample.longid.service.") -> "Service";
            case String s when s.startsWith("com.glinboy.sample.longid.repository.") ||
