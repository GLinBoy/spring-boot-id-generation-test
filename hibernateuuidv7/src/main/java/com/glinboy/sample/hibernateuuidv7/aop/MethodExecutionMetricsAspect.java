package com.glinboy.sample.hibernateuuidv7.aop;
...
public class MethodExecutionMetricsAspect {
    ...
    @Pointcut("execution(* com.glinboy.sample.hibernateuuidv7.web.rest..*(..))")
    private void controllerLayer() {
    }

    @Pointcut("execution(* com.glinboy.sample.hibernateuuidv7.service..*(..))")
    private void serviceLayer() {
    }

    @Pointcut("execution(* com.glinboy.sample.hibernateuuidv7.repository..*(..))")
    ...
    private String determineLayer(ProceedingJoinPoint joinPoint) {
        return switch (joinPoint.getSignature().getDeclaringTypeName()) {
            case String s when s.startsWith("com.glinboy.sample.hibernateuuidv7.web.rest.") -> "Controller";
            case String s when s.startsWith("com.glinboy.sample.hibernateuuidv7.service.") -> "Service";
            case String s when s.startsWith("com.glinboy.sample.hibernateuuidv7.repository.") ||
