package com.glinboy.sample.javauuid.aop;
...
public class MethodExecutionMetricsAspect {
    ...
    @Pointcut("execution(* com.glinboy.sample.javauuid.web.rest..*(..))")
    private void controllerLayer() {
    }

    @Pointcut("execution(* com.glinboy.sample.javauuid.service..*(..))")
    private void serviceLayer() {
    }

    @Pointcut("execution(* com.glinboy.sample.javauuid.repository..*(..))")
    ...
    private String determineLayer(ProceedingJoinPoint joinPoint) {
        return switch (joinPoint.getSignature().getDeclaringTypeName()) {
            case String s when s.startsWith("com.glinboy.sample.javauuid.web.rest.") -> "Controller";
            case String s when s.startsWith("com.glinboy.sample.javauuid.service.") -> "Service";
            case String s when s.startsWith("com.glinboy.sample.javauuid.repository.") ||
